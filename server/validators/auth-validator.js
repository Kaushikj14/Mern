...
const signupSchema = z.object({
    ...
    phone:z
    .string({required_error:"Phone Number is required"}).trim().min(10,{message:"Phone Number must be atleast 10 characters"}).max(10,{message:"Phone number must be atmost 12 characters only"}),
